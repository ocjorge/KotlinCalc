...
public class LegacyParser {
    ...
    private Map<String, Integer> variableValues = new HashMap<>(); // Para almacenar los valores numéricos actuales de las variables
    ...
    public static class ExpressionData {
        ...
        public String toString() {
            ...
            sb.append("  Original (Infija): ").append(LegacyParser.tokensToString(infixTokens)).append("\n"); // Cambio aquí
    ...
    public LegacyParser(List<Token> tokens) { // Cambio aquí
        this.tokens = tokens;
    }
    ...
    private QuadrupleGenerationResult generateQuadruples(List<Token> infixTokens, String finalTarget) {
        ...
        if (!operandStack.isEmpty()) {
            ...
            if (finalTarget.equals("print_target")) {
                ...
                quadruples.add(String.format("RANGE_START %s", finalExpressionResult)); // CORREGIDO AQUÍ
            } else if (finalTarget.equals("range_end")) {
                quadruples.add(String.format("RANGE_END %s", finalExpressionResult));   // CORREGIDO AQUÍ
